...
export const beltProfiles: Record<BeltType, ToothProfile> = {
  GT2: {
    ...
    toothDepth: 0.75, // Добавлено: реальная глубина зуба для расчёта O.D
    angle: 40,
  },
  GT3: {
    pitch: 3,
    ...
    toothDepth: 1.0, // для GT3 приблизительно
    angle: 40,
  },
  T5: {
    pitch: 5,
    ...
    toothDepth: 1.2, // !!! Очень важно: для T5 глубина канавки 1.2 мм
    angle: 40,
    minTeeth: 12,
    maxTeeth: 60
  },
  T10: {
    ...
    toothDepth: 2.5, // Для T10 глубина около 2.5 мм
    angle: 40,
  },
  HTD3M: {
    pitch: 3,
    ...
    toothDepth: 1.15, // HTD3M глубина зуба
    angle: 40,
  },
  HTD5M: {
    pitch: 5,
    ...
    toothDepth: 1.95, // HTD5M глубина зуба
    angle: 40,
  },
};
